...
def self_test():
    ...
    if RunInputPort is not None:
        numPorts += 1
        if verbosity:
            print('Run Input via Maestro board %2d channel %2d' %
                (RunInputPort['boardid'], RunInputPort['firstchannel']))
    if MainInputPort is not None:
        numPorts += 1
        if verbosity:
            print('Main Input via Maestro board %2d channel %2d' %
                (MainInputPort['boardid'], MainInputPort['firstchannel']))
    if TriggerInputPort is not None:
        numPorts += 1
        if verbosity:
            print('Trigger Input via Maestro board %2d channel %2d' %
                (TriggerInputPort['boardid'], TriggerInputPort['firstchannel']))
    ...
    print('\nConfiguration has %d total input ports via Maestro' % numPorts)
